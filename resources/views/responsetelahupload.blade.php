                                                ...
                                                ?>
                                                    <p><b>{{$nama}}&nbsp;</b>, {{$pesan}}</p>
                                                      ...
                                                      <?php
                                                        if ($verifikasi==1){ ?> 
                                                            <div class="btn-part">
                                                               <button class="btn readon2 blue" onclick="openForm()">KLIK DISINI UNTUK ISI BIODATA DAN UPLOAD PERSYARATAN</button>
                                                        ...
                                                        <div class="form-popup" id="myForm">
                                                                  ...
                                                                  <form method="post" enctype="multipart/form-data" action="{{ url('simpancalonsiswa') }}" class="form-container">
                                                                    <input type="hidden" name="_token" value="{!! csrf_token() !!}">
