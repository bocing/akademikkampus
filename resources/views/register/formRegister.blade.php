            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url(action('RegisterController@postRegister')) }}">
                        ...
                        <div class="form-group{{ $errors->has('koref') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Kode Referensi</label>

                            <div class="col-md-3">
                                <input type="text" class="form-control" name="koref" value="{{ old('koref') }}">

                                @if ($errors->has('koref'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('koref') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
