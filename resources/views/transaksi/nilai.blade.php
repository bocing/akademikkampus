...
?> 
  ...
  <div class="content-wrapper">
    ...
    <form method="post" enctype="multipart/form-data" action="<?=URL::to('carinamasiswanilai'.'/'.$induk)  ?>">
                     ...
                     <table class="table table-hover">
                          ...
                          ?>          
                                            ...
                                            <td><a href="#"> {{$abc->namasiswa}}</a></td>
                                                      ...
                                                      <td align="center">  
                                              <a href="{{ URL::asset('/cetaknilai/'.$abc->idsiswa.'/'.$induk.'/'.$idtahun) }}" target="_blank"    >
