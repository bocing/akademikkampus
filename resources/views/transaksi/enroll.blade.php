      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="hidden-sm hidden-xs action-buttons" align="center">
            ...
            <a class="green" href="<?php echo '../formenroll/'.$abc->idkls .'/'.$induk?>">
              <i class="ace-icon fa fa-edit bigger-130"></i>
            </a>&nbsp;&nbsp;
            <a class="green" href="<?php echo '../cetaksiswaperkelas/'.$abc->idkls?>">
              <i class="fa  fa-file-pdf-o"></i>
            </a>&nbsp;&nbsp;

             <a class="green" href="<?php echo '../previewsiswaperkelas/'.$abc->idkls?>" target='_blank' >
