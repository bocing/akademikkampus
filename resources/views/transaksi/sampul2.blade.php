...
?> 
  ...
  <div class="content-wrapper">
    ...
    <form method="post" enctype="multipart/form-data" action="<?=URL::to('carinamasiswsampul2'.'/'.$induk)  ?>">
              ...
              <div class="form-group">
                 ...
                 <div class="box-body">
                   ...
                   <td>
                    ...
                    <a href="{{ URL::asset('/cetaksampul2/'.$idkelas.'/'.$induk) }}" target="_blank" >Cetak Per Kelas
                     ...
                     <table class="table table-hover">
                          ...
                          ?>          
                                            ...
                                            <td><a href="#"> {{$abc->namasiswa}}</a></td>
                                                      ...
                                                      <td align="center">  
                                              <a href="{{ URL::asset('/cetaksampul22/'.$abc->idsiswa.'/'.$induk) }}" target="_blank"    >
                                            <i class="fa fa-fw fa-print"></i>
