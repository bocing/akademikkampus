...
?> 
  ...
  <div class="content-wrapper">
    ...
    <form method="post" enctype="multipart/form-data" action="<?=URL::to('carinamasiswaeks'.'/'.$induk)  ?>">
      ...
      <div class="row">
        ...
        <?php  if ($simpan =='Y') {?>                                      
            ...
            <div class="box-body">
                     ...
                     <table class="table table-hover">
                                      <thead>
                                        <tr>
                                          ...
                                          <th style="width: 7%">Nilai Huruf </th>  
                          ...
                          <?php 
                            ...
                            $rec2=DB::table('t_nikaleks')
                                    ...
                                    ->first();
                                   if ($rec2!=null){
                                      $nama_eks=$rec2->nama_eks;
                                      $nilai=$rec2->nilai;
                                      $ket=$rec2->ket;

                                      $nama_eks2=$rec2->nama_eks2;
                                      $nilai2=$rec2->nilai2;
                                      $ket2=$rec2->ket2;

                                       $nama_eks3=$rec2->nama_eks3;
                                      $nilai3=$rec2->nilai3;
                                      $ket3=$rec2->ket3;
                ...
                <th align="center" >
                <input  class="form-control"      type="text" name="nama_eks[]" type="text" id="nama_eks" value="{{ isset($nama_eks) ? $nama_eks : '' }}"> 
                </th>
                <th>
                <input   class="form-control" maxlength="5"  type="text" name="nilai[]" type="text" id="nilai" value="{{ isset($nilai) ? $nilai : '' }}"> 
                </th>
                <th align="center">
                ...
                <th></th>
                <th align="center" >
                <input  class="form-control"      type="text" name="nama_eks2[]" type="text" id="nama_eks2" value="{{ isset($nama_eks2) ? $nama_eks2 : '' }}"> 
                </th>
                <th>
                <input   class="form-control" maxlength="5"  type="text" name="nilai2[]" type="text" id="nilai2" value="{{ isset($nilai2) ? $nilai2 : '' }}"> 
                </th>
                <th align="center">
                ...
                <th></th>
                    ...
                    <th align="center" >
                <input  class="form-control"      type="text" name="nama_eks3[]" type="text" id="nama_eks3" value="{{ isset($nama_eks3) ? $nama_eks3 : '' }}"> 
                </th>
                <th>
                <input   class="form-control" maxlength="5"  type="text" name="nilai3[]" type="text" id="nilai3" value="{{ isset($nilai3) ? $nilai3 : '' }}"> 
                </th>
                <th align="center">
