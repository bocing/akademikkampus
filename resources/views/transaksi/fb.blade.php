...
//dd($master)
  ...
  if(count ($rec) <= 0  ){
      ...
      $nobel = $m->nobel;
      //$idter = $m->idter;
      $tglbel = date('m/d/Y', strtotime($m->tglbel)) ;
      $ket    = $m->ket;
      $idpel = $m->idsup;  
      $iddep = $m->iddep;     
      $jml = 0;
...
?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      {{ csrf_field() }}
        ...
        <li><a href="{{url($m->url)}}/{{$m->id_induk}}"><i class="{{$m->icon}}"></i> {{$m->nama}}</a></li>
         @endforeach()               
         <li><a href="{{ url('formbeli/'.$induk) }}"><i class="fa fa-fw fa-plus"></i> Tambah </a> </li>
    ...
    <section class="content">
      ...
      <!-- /.box -->
      <form method="post" enctype="multipart/form-data" action="<?=URL::to('savebeli')  ?>">
                                      ...
                                      <tbody>
                                           {{ csrf_field() }}
                                            ...
                                            <td>
                                              ...
                                              <a href="{{ URL::asset('/deletebelidetil/'.$abc->id.'/'.$induk) }}" onclick="return confirm('Anda Yakin Menghapus?')"  class="red"    >
