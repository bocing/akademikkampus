...
?> 
  ...
  <div class="content-wrapper">
    ...
    <form method="post" enctype="multipart/form-data" action="<?=URL::to('carinamasiswapsg'.'/'.$induk)  ?>">
 ...
 <form method="post" enctype="multipart/form-data" action="<?=URL::to('simpannilaipsg'.'/'.$idkelas.'/'.$induk)  ?>">
          <input type="hidden" name="_token" value="{!! csrf_token() !!}">    
          <input type="hidden" name="induk" value="{{$induk}}">    
      ...
      <div class="row">
        ...
        <?php  if ($simpan =='Y') {?>                                      
            ...
            <div class="box-body">
                ...
                <th align="center">
                <input  class="form-control"    maxlength="2" type="text" id="cat[]" name="cat[]" placeholder="" value="{{ isset($cat) ? $cat : '' }}"
                </th>
                                            ...
                                            <td>
                                              ...
                                              <a href="{{ URL::asset('/inputnilaiakhir/'.$abc->id.'/'.$induk) }}"   class="red"    >
