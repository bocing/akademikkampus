...
?> 
  ...
  <div class="content-wrapper">
    ...
    <form method="post" enctype="multipart/form-data" action="<?=URL::to('carinamasiswsabiodata'.'/'.$induk)  ?>">
              ...
              <div class="form-group">
                 ...
                 <div class="box-body">
                   ...
                   <td>
                    ...
                    <a href="{{ URL::asset('/cetakbiodata/'.$idkelas.'/'.$induk) }}" target="_blank" >Cetak Per Kelas
                     ...
                     <table class="table table-hover">
                          ...
                          ?>          
                                            ...
                                            <td><a href="#"> {{$abc->namasiswa}}</a></td>
                                                      ...
                                                      <td align="center">  
                                              <a href="{{ URL::asset('/cetakbiodata2/'.$abc->idsiswa.'/'.$induk) }}" target="_blank"    >
                                            <i class="fa fa-fw fa-print"></i>
