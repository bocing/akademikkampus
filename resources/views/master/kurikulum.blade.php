...
<input type="hidden" name="hidden_view" id="hidden_view" value="{{url('crud/viewkur')}}">  
  <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('crud/deletekur')}}">  
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" enctype="multipart/form-data" action="<?=URL::to('sikur')  ?>">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                 <b>Aktif</b>           
                  <input type="text" name="aktif"  value="{{ isset($aktif) ? $aktif : '' }}" required data-validation-required-message="Please enter your name."  class="form-control"><br/>                                  
              </div>  
  ...
  <div class="modal fade" id="editModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" enctype="multipart/form-data" action="<?=URL::to('upkur')  ?>">
                 <input type="hidden" name="_token" value="{!! csrf_token() !!}">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <b>Aktif</b>           
                  <input type="text" id="edit_aktif" name="edit_aktif"  required data-validation-required-message="Please enter your name."  class="form-control"><br/>                                  
              </div>
