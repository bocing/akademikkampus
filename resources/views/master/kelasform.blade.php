...
?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- /.box -->
<form method="post" enctype="multipart/form-data" action="<?=URL::to('simpaneditkelas')  ?>">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-danger">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kapasitas" name="kapasitas" value="{{ isset($kapasitas) ? $kapasitas : '' }}" >
              </div>
           <div class="form-group">
