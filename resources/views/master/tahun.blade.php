...
<input type="hidden" name="hidden_view" id="hidden_view" value="{{url('crud/viewtahun')}}">  
  <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('crud/deletetahun')}}">  
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('simpantahun') }}" method="post">
            {{ csrf_field() }}
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label for="last_name">Aktif :</label>
                <input type="text" class="form-control" id="aktif" name="aktif">[Y/T]
              </div>
