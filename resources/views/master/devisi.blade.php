...
<input type="hidden" name="hidden_view" id="hidden_view" value="{{url('crud/viewdev')}}">  
  <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('crud/deletedev')}}">  
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('simpandev') }}" method="post">
            {{ csrf_field() }}
            <div class="form-group">
               
              <div class="form-group">
                <label for="last_name">Nama Devisi:</label>
  ...
  <div class="modal fade" id="editModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('crud/updatedev') }}" method="post">
            {{ csrf_field() }}
            <div class="form-group">
