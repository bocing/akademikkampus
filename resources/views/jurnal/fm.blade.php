...
?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- /.box -->
      <form method="post" enctype="multipart/form-data" action="<?=URL::to('savekm')  ?>">
                 ...
                 <div class="box-body">               
                      ...
                      <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-sm-6"> 
                                  <b>Keterangan</b>            
                                 <input type="text"   id="ketu"  name="ketu" value="{{ isset($ketu) ? $ketu : 'xxxx' }}"  class="form-control" required data-validation-required-message="Please enter your nama."     >                  
                             </div>  
                                      ...
                                      <tbody>
                                           {{ csrf_field() }}
                                            ...
                                            <td>
                                              ...
                                              <a href="{{ URL::asset('/deletekmdetil/'.$abc->id.'/'.$induk) }}" onclick="return confirm('Anda Yakin Menghapus?')"  class="red"    >
