...
td {
	...
	<?php  $data=DB::table('kelassiswa')  
                  ->leftjoin('siswa', 'siswa.id', '=', 'kelassiswa.idsiswa')            
                  ->leftjoin('tahun', 'tahun.id', '=', 'kelassiswa.tahunid')            
                  ->select('kelassiswa.*','siswa.nama as namasiswa','siswa.nis as nissiswa','tahun.nama as namatahun')
  ...
  <a class="toolbar" href="#" onclick="window.print();return false;">Print</a>
    ...
    <div align="center">  
	 <table width="30%"  border="2">
       <tr>
         <td align="left"><div align="center"><?php echo $row->namasiswa; ?></div></td>
       </tr>
     </table>
	 <p>&nbsp;</p>
	 </div>
	 ...
	 <table width="30%"  border="1">
       <tr>
         <td align="left"><div align="center"><?php echo $row->nissiswa; ?></div></td>
       </tr>
     </table>
	 </div>
	 <p align="center">&nbsp;</p>
    ...
    <div align="center">  
	 <table width="30%"  border="1">
       <tr>
         <td align="left"><div align="center"><?php echo $row->namatahun; ?></div></td>
       </tr>
     </table>
	 <p>&nbsp;</p>
	 <p>&nbsp;</p>
